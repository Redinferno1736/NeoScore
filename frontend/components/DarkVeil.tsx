...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    // Full-screen triangle — 3 positions cover the entire clip space
    ...
    const resize = () => {
      ...
      canvas.width  = w * resolutionScale * dpr;
      canvas.height = h * resolutionScale * dpr;
  ...
  return <canvas ref={ref} className="w-full h-full block" style={{ display: "block" }} />;
}
